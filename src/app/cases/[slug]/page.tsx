...
const CASES_DATA: Record<string, {
  ...
  "atlas-festival": {
    title: "Atlas Festival 2024", category: "Event · Production", year: "2024", color: "#c8a45a",
  ...
  "echo-digital": {
    title: "Echo Digital Platform", category: "Digital · Стратегия", year: "2023", color: "#4ecdc4",
  ...
  "forma-rebrand": {
    title: "Forma — ребрендинг", category: "Брендинг · Digital", year: "2023", color: "#f7b267",
  ...
  "pulse-content": {
    title: "Pulse Content Strategy", category: "Маркетинг · Production", year: "2022", color: "#a8e6cf",
